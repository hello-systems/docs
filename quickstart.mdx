...
Go to [app.script.so](https://app.script.so) and sign in.

## 2. Create a Workflow

Click **New Workflow** from the dashboard, or type directly in the prompt box.
...
<Tip>Use `@mentions` to reference integrations: `Send email via @Gmail`</Tip>
